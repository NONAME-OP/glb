...
loader.load('models/gltf/graces-draco2.glb', function (gltf) {
    ...
    gltf.scene.traverse((obj) => {
        if (obj.isMesh) {
            // Only try modifying if it's a compatible material
    ...
    if (gltf.animations && gltf.animations.length > 0) {
        ...
        // Add a simple rotation animation to test the animation system
...
<h2 class="subheading">
    ...
    currentAudio = new Audio('AUDIO/kk.mp3');
    currentAudio.play();
   // Create the button
...
document.getElementById('thalia').addEventListener('click', () => {
    ...
    currentAudio = new Audio('AUDIO/vv.mp3');
    currentAudio.play();
})
//J
document.getElementById('euphre').addEventListener('click', () => {
    ...
    `;
    animateCamera({ x: -2.4, y: 0.4, z: -0.4 },{x:0,z:0, y: -0.0 })
    currentAudio = new Audio('AUDIO/josi.mp3');
    currentAudio.play();
})//ZAYA
...
<div class="social-links">
    ...
    currentAudio = new Audio('AUDIO/s.mp3');
    currentAudio.play();
})//suk
document.getElementById('RAN').addEventListener('click', () => {
    ...
    `;
    animateCamera({ x: -6.25, y: 1.2, z: -0.7 },{ x:0,z:0,y: -0.0 })
    currentAudio = new Audio('AUDIO/luffy.mp3');
    currentAudio.play();})
//sd    
document.getElementById('sh').addEventListener('click', () => {
    if (currentAudio) { currentAudio.pause(); currentAudio.currentTime = 0; }
        ...
        <h2 class="subheading">
    With expertise across these software tools, we bring creative and effective solutions to a wide range of platforms.
</h2>	<div class="social-links"><div id="twitter" class="social-btn flex-center">
    <a href="https://www.linkedin.com/in/shishir-dheep-756441287/" target="_blank" class="flex-center">
        <svg viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 4.557c-.883.392-1.832.656-2.828.775
                     1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195
                     -.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045
