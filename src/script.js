...
const MODEL_URLS = {
    primary: 'https://github.com/NONAME-OP/glb/releases/download/gg/graces-draco2.glb',
    fallback: 'https://github.com/NONAME-OP/glb/releases/download/gg/graces-draco2.glb' // Keep local as fallback
};
...
<h2 class="subheading">
    ...
    currentAudio = new Audio('dist/audio/kk.mp3');
    currentAudio.play();
})
...
document.getElementById('thalia').addEventListener('click', () => {
    ...
    `;
    animateCamera({ x: 1.0, y: 0.5, z: 1.9 },{ x:0,z:0,y: -0.1 })//ANIMATE CAMERA
    currentAudio = new Audio('dist/assets/audio/kk.mp3');
    currentAudio.play();
})
...
document.getElementById('thalia').addEventListener('click', () => {
    ...
    currentAudio = new Audio('dist/audio/vinint.mp3');
    currentAudio.play();
})
...
document.getElementById('euphre').addEventListener('click', () => {
    ...
    currentAudio = new Audio('dist/audio/josi.mp3');
    currentAudio.play();
})
...
document.getElementById('SAI').addEventListener('click', () => {
    ...
    currentAudio = new Audio('dist/audio/zz.mp3');
...
<div class="social-links">
    ...
    currentAudio = new Audio('dist/audio/s.mp3');
    currentAudio.play();
})//suk
...
document.getElementById('sh').addEventListener('click', () => {
    ...
    currentAudio = new Audio('/dist/AUDIO/vv.mp3');
    currentAudio.play();
})
